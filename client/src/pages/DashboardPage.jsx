                        ...
                        <div className='p-5'>
                            <div className='flex items-start justify-between'>
                                <div className='flex items-center space-x-2'>
                                    <IoIosArrowUp size='2em' className='mb-2 cursor-pointer hover:text-green-500'/>
                            ...
                            <div className='p-3 mb-4 bg-white rounded shadow-lg cursor-pointer hover:bg-blue-400 hover:text-white hover:font-bold'>
                                <div className="flex space-x-2">
                                    <div className='p-1 bg-white rounded-full'><FcDocument size='3em'/></div>
                                    <div>
                                    ...
                                    <div className="w-full p-3 bg-gray-200 border-b border-gray-300 filters">
                                        <div className="flex flex-col space-y-2">
                                            <div className='flex items-center space-x-2'>
                                                ...
                                                <button className='p-1 px-3 text-sm text-white bg-blue-400 rounded-full'>Assigned to me (1)</button>
                                                <button className='p-1 px-3 text-sm text-white bg-blue-400 rounded-full'>Created by me (1)</button>
                                            </div>
                                            <div className='flex items-center space-x-2'>
                                                <h5 className='font-semibold text-md'>
                                                    Due date: 
                                                </h5>
                                                <button className='p-1 px-3 text-sm text-white bg-blue-400 rounded-full'>All</button>
                                                <button className='p-1 px-3 text-sm text-white bg-blue-400 rounded-full'>4 Days (0)</button>
                                                <button className='p-1 px-3 text-sm text-white bg-blue-400 rounded-full'>Due Today (0)</button>
                                                <button className='p-1 px-3 text-sm text-white bg-blue-400 rounded-full'>Over Due (5)</button>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="table w-full p-3 issues">
                                        <table className='w-full text-center border'>
                                            ...
                                            <tr>
                                                ...
                                                <td><IoMdArrowUp size='1em' color='red'/></td>
                                                <td><button className='p-1 px-3 text-sm text-white bg-red-400 rounded-full'>Open</button></td>
                                                <td>Jan.29</td>
                                            </tr>
                                        </table>
                                    </div>
